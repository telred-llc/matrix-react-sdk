...
export default class ChatCreateOrReuseDialog extends React.Component {
    ...
    componentWillMount() {
        ...
        if (tiles.length === 0) {
            ...
            MatrixClientPeg.get()
                .getProfileInfo(this.props.userId)
                .done(
                    resp => {
                        const profile = {
                    ...
                    err => {
                        console.error(
                            'Unable to get profile for user ' +
                                this.props.userId +
                                ':',
                            err
                        );
    ...
    render() {
        ...
        if (this.state.tiles.length > 0) {
            ...
            if (this.state.busyProfile) {
                ...
                profile = (
                    <div className='mx_ChatCreateOrReuseDialog_profile'>
                        <BaseAvatar
                            name={
            ...
            content = (
                <div>
                    ...
                    <DialogButtons
                        primaryButton={_t('Start Chatting')}
