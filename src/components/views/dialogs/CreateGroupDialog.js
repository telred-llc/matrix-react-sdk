...
export default createReactClass({
    ...
    _checkGroupId: function(e) {
        ...
        if (!this.state.groupId) {
            ...
            error = _t(
                "Community IDs may only contain characters a-z, 0-9, or '=_-./'"
            );
        }
        this.setState({
            groupIdError: error,
        ...
        if (this.state.createError) {
            ...
            createErrorNode = (
                <div className='error' role='alert'>
                    <div>
                        {_t(
                            'Something went wrong whilst creating your community'
                        )}
                    </div>
            ...
            >
                <form onSubmit={this._onFormSubmit}>
                    <div className='mx_Dialog_content'>
                        ...
                        <div className='mx_CreateGroupDialog_inputRow'>
                            ...
                            <div className='mx_CreateGroupDialog_input_group'>
                                <span className='mx_CreateGroupDialog_prefix'>
                                    +
                                </span>
                                <input
                                    id='groupid'
                        ...
                        <div className='error'>{this.state.groupIdError}</div>
                        {createErrorNode}
                    </div>
                    <div className='mx_Dialog_buttons'>
                        ...
                        />
                        <button onClick={this._onCancel}>{_t('Cancel')}</button>
                    </div>
                </form>
            </BaseDialog>
        );
