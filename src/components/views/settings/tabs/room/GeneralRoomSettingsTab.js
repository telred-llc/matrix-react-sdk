...
export default class GeneralRoomSettingsTab extends React.Component {
    ...
    componentWillMount() {
        MatrixClientPeg.get()
            .getRoomDirectoryVisibility(this.props.roomId)
            .then(result => {
                this.setState({
    ...
    render() {
        ...
        const canActuallySetAliases = room.currentState.mayClientSendStateEvent(
            'm.room.aliases',
            client
        );
            ...
            <div className='mx_SettingsTab mx_GeneralRoomSettingsTab'>
                ...
                <div className='mx_SettingsTab_section'>
                    <LabelledToggleSwitch
                        ...
                        label={_t(
                            "Publish this room to the public in %(domain)s's room directory?",
                            {
