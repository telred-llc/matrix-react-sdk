...
export default class SecurityRoomSettingsTab extends React.Component {
    ...
    componentWillMount(): void {
        ...
        const encrypted = MatrixClientPeg.get().isRoomEncrypted(
            this.props.roomId
        );
    ...
    _onEncryptionChange = e => {
        Modal.createTrackedDialog('Enable encryption', '', QuestionDialog, {
            ...
            onFinished: confirm => {
                ...
                MatrixClientPeg.get()
                    .sendStateEvent(this.props.roomId, 'm.room.encryption', {
    ...
    _updateBlacklistDevicesFlag = checked => {
        MatrixClientPeg.get()
            ...
            .setBlacklistUnverifiedDevices(checked);
    };
    ...
    _renderRoomAccess() {
        ...
        const aliasEvents =
            room.currentState.getStateEvents('m.room.aliases') || [];
        const hasAliases = !!aliasEvents.find(
            ev => (ev.getContent().aliases || []).length > 0
        );
            ...
            guestWarning = (
                <div className='mx_SecurityRoomSettingsTab_warning'>
                    ...
                    <span>
                        ...
                        &nbsp;
                        <a href='' onClick={this._fixGuestAccess}>
    ...
    render() {
        ...
        const hasEncryptionPermission = room.currentState.mayClientSendStateEvent(
            'm.room.encryption',
            client
        );
